...
public class DatabaseConfig {
	...
	/*
	 * Defines whether the replication is of type partitioned or global (mandatory)
	 */
	...
	private DatabaseConfig(DatabaseConfigBuilder builder) {
		...
		if (builder.partitionType == null
				|| EnumUtils.getEnum(PartitionType.class, builder.partitionType.name()) == null) {
