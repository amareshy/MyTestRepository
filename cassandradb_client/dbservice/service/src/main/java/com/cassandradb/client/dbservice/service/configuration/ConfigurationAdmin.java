...
public interface ConfigurationAdmin {
     ...
     * @throws ProcessingException            when the cluster is unable to process the request
     */
     ...
     * @throws InvalidRequestException thrown if invalid input was given
     * @throws ConfigNotFoundException thrown if there is no existing configuration to update
     * @throws ProcessingException     when the cluster is unable to process the request
     */
     ...
     * @throws InvalidRequestException thrown if invalid input was given, for example the database does not exist
     * @throws ProcessingException     when the cluster is unable to process the request
     */
     ...
     *
     * @param databaseConfig the database configuration to retrieve the partitions from
